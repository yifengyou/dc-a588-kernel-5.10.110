		...
		struct v4l2_dv_timings *timings)
{
	...
	lt6911uxc->audio_sampling_rate = 48000;
...
static int lt6911uxc_parse_of(struct lt6911uxc *lt6911uxc, struct device *dev)
{
...
static int lt6911uxc_probe(struct platform_device * pdev)
{
	...
	err = lt6911uxc_parse_of(lt6911uxc, dev);
	if (err) {
...
*/
	...
	printk("ztl test 9611 aaaaaaaaaaa sssssss\n");
	return 0;
...
static struct platform_driver lt6911uxc_driver = {
	.driver = {
		.name = LT6911UXC_NAME,
...
static int __init lt6911uxc_driver_init(void)
{
	...
	return platform_driver_register(&lt6911uxc_driver);
}

static void __exit lt6911uxc_driver_exit(void)
{
	//i2c_del_driver(&lt6911uxc_driver);
	platform_driver_unregister(&lt6911uxc_driver);
}
