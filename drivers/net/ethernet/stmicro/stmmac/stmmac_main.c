...
#define RTL_8211E_PHY_ID   0x001cc916
...
#endif
#if 0
static int phy_rtl8111_led_fixup(struct phy_device *phydev)
{
       u32 val;
       val = 0x6171;     
		     ...
		     struct stmmac_resources *res)
{
	...
	/*fixed for phy intergated circuit*/
	
	ret = phy_register_fixup_for_uid(RTL_8211E_PHY_ID, 0x001fffff, phy_rtl8211e_led_fixup);
	if (ret)
		pr_warn("Cannot register RTL8211E PHY board fixup.\n");	

	ret = phy_register_fixup_for_uid(RTL_8211E_PHY_ID, 0xffffffff, phy_rtl8211e_eee_fixup);
	if (ret)
